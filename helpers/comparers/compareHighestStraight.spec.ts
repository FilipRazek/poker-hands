...
describe("compareHighestStraight", () => {
  ...
  it("should correctly compare the highest straight", () => {
    expect(compareHighestStraight(straightWithAce, straightWithKing)).toEqual(
      1
    );
  });

  it("should return -1 if the second hand has the highest straight", () => {
    expect(compareHighestStraight(straightWithKing, straightWithAce)).toEqual(
      -1
    );
  });
  ...
  it("should return 0 if the hands are equal", () => {
    expect(compareHighestStraight(straightWithAce, straightWithAce)).toEqual(
      0
    );
  });
});
